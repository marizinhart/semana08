        ...
        alternativas: [
            {
                ...
                "Como uma forma de melhoração,"
                ]
            },
            {
                texto: "horrível!",
             afirmacao:[ "A tecnlogia é um problema nos dias de hoje,",
             "Não vai facilitar a vida de ninguém"
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [ "nos auxiliando em tudo que precisamos,",
                  "vai nos proporcionar melhoramento,"
                ]
            },
            {
                exto:  "É uma capacidade que não trás benefício nenhum",
                afirmacao: [ "ela nos tira a concentração,",
                   "não nos deixa ficar focados no que vamos fazer,"
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [ "alem de ser uma forma mais pratica e facil de se conectar.",
                 "sera muito mais facil de se conectar,"
                ]
            },
            {
                texto: "Não é usada em nada!",
                afirmacao: [  "nos causam problemas na saude, entre outros.",
                 "vai nos trazer malefícios para nosso bem estar,"
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                "A tecnologia veio nos desconectar do mundo real."
            ]
            },
            {
               texto:"Nos ajudando a fazer um trabalho, orgânizando nossos horarios!",
                afirmacao: [ "A tecnologia é um grande melhoramento de vida.",
                "Portanto a tecnologia é uma ferramenta estremamente utíl."
            ]
            }
        ]
    },
